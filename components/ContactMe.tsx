...
function ContactMe({ pageInfo }: Props) {
  ...
  return (
    <div className="relative flex flex-col items-center h-screen px-10 mx-auto text-center md:text-left md:flex-row max-w-7xl justify-evenly">
      ...
      <div className="max-h-[320px] sm:max-h-[360] md:max-h-none">
        <div className="flex flex-col space-y-1 sm:mt-5 md:mt-3 lg:mt-0 sm:space-y-2 md:space-y-4 lg:space-y-10">
