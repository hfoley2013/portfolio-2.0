  ...
  return (
    includedSkills ? (
      <motion.div
        ...
        className="relative flex flex-col h-screen text-center max-w-[2000px] xl:px-10 justify-center lg:grid-flow-col"
      >
        ...
        <div className="relative grid justify-center grid-cols-3 gap-2 mt-12 lg:mt-14 xl:mt-24 lg:grid-cols-4 justify-items-center align-items-center lg:gap-y-5">
